...
const SeparatorVerticalTopScrew: React.FC<SeparatorVerticalTopScrewProps> = ({ className, addScrews }) => {
    ...
    const addSquares = (count: number) => {
        ...
        for (let i = 0; i < count; i++) {
            const backgroundColor = i === activeDotIndex ? '#000000' : '#6B8E2344';
            squares.push(
                <div
                    key={i}
                    style={{ 
