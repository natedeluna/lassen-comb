...
export const PriceCard = ({ title, description, price, frequency, features, className }: PriceCardProps) => {
    return (
        <div
            id='price-card'
            style={{
            ...
            <div className='flex flex-col gap-7'>
                ...
                <div id='price-details'>
                    ...
                    <div className='flex gap-[8px] items-center my-3'>
                        <div className='text-[40px]  font-[Haskoy-semi] '>{price}</div>
                        <div className='text-[14px] font-medium text-[#afafaf]'>{frequency}</div>
                    </div>
                    <div className='h-1 w-full flex gap-[2px] justify-start'>
                        <div className='dot'></div>
                        <div className='dot'></div>
                ...
                <div id='features' className=' flex flex-col gap-3 text-[#3d3d3d] text-[Haskoy-med] text-[16px]'>
